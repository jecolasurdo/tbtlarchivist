...
//                         1,
//                     );
//                     match resampler.process(&mono_data) {
//                         Ok(mut resampled_data) => raw_data.append(&mut resampled_data[0]),
//                         // Err(_) => return Err(anyhow!("mp3_to_raw: resampler returned an error.")),
//                     }
//                 }
...
// pub fn to_monaural(data: &[i16], channels: usize) -> Result<Vec<f64>> {
