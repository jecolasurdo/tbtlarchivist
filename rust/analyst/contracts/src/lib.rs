...
pub struct CompletedResearchItem {
    ...
    pub episode_hash: ::std::vec::Vec<u8>,
    pub clip_duration: i64,
    pub clip_hash: ::std::vec::Vec<u8>,
...
impl CompletedResearchItem {
    ...
    // bytes episode_hash = 5;


    pub fn get_episode_hash(&self) -> &[u8] {
        &self.episode_hash
    }
    ...
    // Param is passed by value, moved
    pub fn set_episode_hash(&mut self, v: ::std::vec::Vec<u8>) {
        self.episode_hash = v;
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_episode_hash(&mut self) -> &mut ::std::vec::Vec<u8> {
        &mut self.episode_hash
    }

    // Take field
    pub fn take_episode_hash(&mut self) -> ::std::vec::Vec<u8> {
        ::std::mem::replace(&mut self.episode_hash, ::std::vec::Vec::new())
    }
    ...
    // Param is passed by value, moved
    pub fn set_clip_hash(&mut self, v: ::std::vec::Vec<u8>) {
        self.clip_hash = v;
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_clip_hash(&mut self) -> &mut ::std::vec::Vec<u8> {
        &mut self.clip_hash
    }

    // Take field
    pub fn take_clip_hash(&mut self) -> ::std::vec::Vec<u8> {
        ::std::mem::replace(&mut self.clip_hash, ::std::vec::Vec::new())
    }
...
impl ::protobuf::Message for CompletedResearchItem {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                ...
                5 => {
                    ::protobuf::rt::read_singular_proto3_bytes_into(wire_type, is, &mut self.episode_hash)?;
                },
                6 => {
                    if wire_type != ::protobuf::wire_format::WireTypeVarint {
                        return ::std::result::Result::Err(::protobuf::rt::unexpected_wire_type(wire_type));
                ...
                7 => {
                    ::protobuf::rt::read_singular_proto3_bytes_into(wire_type, is, &mut self.clip_hash)?;
                },
                8 => {
    ...
    fn compute_size(&self) -> u32 {
        ...
        if !self.episode_hash.is_empty() {
            my_size += ::protobuf::rt::bytes_size(5, &self.episode_hash);
        }
        ...
        if !self.clip_hash.is_empty() {
            my_size += ::protobuf::rt::bytes_size(7, &self.clip_hash);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        ...
        if !self.episode_hash.is_empty() {
            os.write_bytes(5, &self.episode_hash)?;
        }
        if self.clip_duration != 0 {
            os.write_int64(6, self.clip_duration)?;
        }
        if !self.clip_hash.is_empty() {
            os.write_bytes(7, &self.clip_hash)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    !\n\x0cepisode_hash\x18\x05\x20\x01(\x0cR\x0bepisodeHash\x12#\n\rclip_du\
    ration\x18\x06\x20\x01(\x03R\x0cclipDuration\x12\x1b\n\tclip_hash\x18\
    \x07\x20\x01(\x0cR\x08clipHash\x12!\n\x0cclip_offsets\x18\x08\x20\x03(\
    \x03R\x0bclipOffsets\x12\x19\n\x08lease_id\x18\t\x20\x01(\tR\x07leaseId\
    \x12!\n\x0crevoke_lease\x18\n\x20\x01(\x08R\x0brevokeLeaseB\x17Z\x15go/i\
    nternal/contractsJ\xaa\x0e\n\x06\x12\x04\0\0.\x01\n\x08\n\x01\x0c\x12\
    \x03\0\0\x12\n\x08\n\x01\x02\x12\x03\x01\0\x12\n\t\n\x02\x03\0\x12\x03\
    \x03\0)\n\x08\n\x01\x08\x12\x03\x04\0,\n\t\n\x02\x08\x0b\x12\x03\x04\0,\
    \n\n\n\x02\x04\0\x12\x04\x06\0\x0f\x01\n\n\n\x03\x04\0\x01\x12\x03\x06\
    \x08\x10\n\x0b\n\x04\x04\0\x02\0\x12\x03\x07\x047\n\x0c\n\x05\x04\0\x02\
    \0\x06\x12\x03\x07\x04\x1d\n\x0c\n\x05\x04\0\x02\0\x01\x12\x03\x07\x1e2\
    \n\x0c\n\x05\x04\0\x02\0\x03\x12\x03\x0756\n\x0b\n\x04\x04\0\x02\x01\x12\
    \x03\x08\x044\n\x0c\n\x05\x04\0\x02\x01\x06\x12\x03\x08\x04\x1d\n\x0c\n\
    \x05\x04\0\x02\x01\x01\x12\x03\x08\x1e/\n\x0c\n\x05\x04\0\x02\x01\x03\
    ...
    \x02\x02\0\x01\x12\x03\x1e\x0b\x13\n\x0c\n\x05\x04\x02\x02\0\x03\x12\x03\
    \x1e\x16\x17\n\x0b\n\x04\x04\x02\x02\x01\x12\x03\x1f\x04\x1c\n\x0c\n\x05\
    \x04\x02\x02\x01\x06\x12\x03\x1f\x04\x0f\n\x0c\n\x05\x04\x02\x02\x01\x01\
    \x12\x03\x1f\x10\x17\n\x0c\n\x05\x04\x02\x02\x01\x03\x12\x03\x1f\x1a\x1b\
    \n\x0b\n\x04\x04\x02\x02\x02\x12\x03\x20\x04\x20\n\x0c\n\x05\x04\x02\x02\
    \x02\x04\x12\x03\x20\x04\x0c\n\x0c\n\x05\x04\x02\x02\x02\x06\x12\x03\x20\
    \r\x15\n\x0c\n\x05\x04\x02\x02\x02\x01\x12\x03\x20\x16\x1b\n\x0c\n\x05\
    \x04\x02\x02\x02\x03\x12\x03\x20\x1e\x1f\n\n\n\x02\x04\x03\x12\x04#\0.\
    ...
    \x04\x03\x02\x02\x12\x03&\x04\x1b\n\x0c\n\x05\x04\x03\x02\x02\x06\x12\
