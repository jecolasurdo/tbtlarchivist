...
type CompletedResearchItem struct {
	...
	EpisodeHash     []byte                 `protobuf:"bytes,5,opt,name=episode_hash,json=episodeHash,proto3" json:"episode_hash,omitempty"`
	ClipDuration    int64                  `protobuf:"varint,6,opt,name=clip_duration,json=clipDuration,proto3" json:"clip_duration,omitempty"`
	ClipHash        []byte                 `protobuf:"bytes,7,opt,name=clip_hash,json=clipHash,proto3" json:"clip_hash,omitempty"`
...
func (x *CompletedResearchItem) GetEpisodeHash() []byte {
	if x != nil {
...
func (x *CompletedResearchItem) GetClipHash() []byte {
	if x != nil {
		return x.ClipHash
	}
	return nil
...
var file_protobuf_contracts_proto_rawDesc = []byte{
	...
	0x05, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x0b, 0x65, 0x70, 0x69, 0x73, 0x6f, 0x64, 0x65, 0x48, 0x61,
	...
	0x68, 0x61, 0x73, 0x68, 0x18, 0x07, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x08, 0x63, 0x6c, 0x69, 0x70,
